...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        <form method="POST" action="{{ route('topics.store') }}" id="msform" enctype="multipart/form-data">
            @csrf
            <!-- fieldsets -->
            ...
            <fieldset>
                <h2 class="fs-title">Nouveau Topic dans {{ $souscategorie->libelle }}</h2>
                ...
                <input type="text" name="title" class="@error('title') is-invalid @enderror" placeholder="Entrer votre Topic"/>
