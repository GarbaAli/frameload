			...
			<div class="row no-gutters slider-text align-items-end justify-content-center">
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<p class="breadcrumbs"><span class="mr-2">
						<a href="">Accueil <i class="fa fa-chevron-right"></i></a></span>
						<span>Librairie <i class="fa fa-chevron-right"></i></span>
					</p>
					<h1 class="mb-0 bread">Librairie</h1>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="row">
							...
							<div class="project-wrap">
								...
								<div class="text p-4">
									<ul class="d-flex justify-content-between">
										<h3><a href="{{ route('show_epreuve') }}">Epreuves</a></h3>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-md-6 d-flex align-items-stretch ftco-animate">
							<div class="project-wrap">
								...
								<div class="text p-4">
									<ul class="d-flex justify-content-between">
										<h3><a href="{{ route('show_rapport') }}">Rapports de Stage</a></h3>
									</ul>
								</div>
							</div>
						</div>
