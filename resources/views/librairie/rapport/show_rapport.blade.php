			...
			<div class="row no-gutters slider-text align-items-end justify-content-center">
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<p class="breadcrumbs"><span class="mr-2">
						...
						<span>Rapports de Stage <i class="fa fa-chevron-right"></i></span>
					</p>
		...
		<div class="row">
				<div class="col-lg-3 sidebar">
					<div class="sidebar-box bg-white ftco-animate">
						<form action="{{route('rapport.search')}}" class="d-flex">
				...
				<div class="col-lg-6 pb-3">
					<a href="{{ route('rapport.create') }}" class="btn btn-xm btn-primary">Soumettre un rapport</a>
				</div>
				<div class="col-lg-10">
					<div class="row">
						<table class="table">
							<tbody>
								...
								<tr>
									<td>
										<a href="{{route('view_rapport',$rapports->id)}}" style="color: black;">
											<i class="fa fa-file-pdf"></i> {{$rapports->theme_rapport}} - {{$rapports->filiere->code_filiere}} - {{$rapports->annee_rapport}}
										</a>
									</td>
									<td><a href="{{route('view_rapport',$rapports->id)}}" style="color: black;"><i class="fa fa-download"></i></a></td>
								</tr>
								@endforeach
							</tbody>
						</table>
