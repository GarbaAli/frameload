...
<div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route('categorieForum.update', $categorieForum) }}"> 
      @csrf
      @method('PATCH')
        <hr class="my-4" />
        <!-- Description -->
        ...
        <div class="col-lg-12">
              <div class="form-group">
                ...
                <input type="text" name="libelle" id="libelle" class="form-control @error('libelle') is-invalid @enderror" placeholder="libelle" value="{{ old('libelle') ??$categorieForum->libelle }} " autocomplete="libelle" autofocus>
                @error('libelle')
